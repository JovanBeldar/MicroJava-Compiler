...
public class AbstrClassDeclExtNoList extends AbstractClassDecl {

    private String I1;
    private Type Type;
    private ListOfVarDeclarations ListOfVarDeclarations;

    public AbstrClassDeclExtNoList (String I1, Type Type, ListOfVarDeclarations ListOfVarDeclarations) {
        this.I1=I1;
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AbstrClassDeclExtNoList(\n");
