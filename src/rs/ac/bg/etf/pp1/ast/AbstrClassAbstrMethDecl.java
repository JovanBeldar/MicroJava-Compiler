...
public class AbstrClassAbstrMethDecl extends AbstractClassListPart {

    private AbstractMethodDecl AbstractMethodDecl;

    public AbstrClassAbstrMethDecl (AbstractMethodDecl AbstractMethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AbstrClassAbstrMethDecl(\n");
