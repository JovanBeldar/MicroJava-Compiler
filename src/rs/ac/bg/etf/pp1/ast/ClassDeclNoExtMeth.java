...
public class ClassDeclNoExtMeth extends ClassDecl {

    private String I1;
    private ListOfVarDeclarations ListOfVarDeclarations;
    private MethDeclList MethDeclList;

    public ClassDeclNoExtMeth (String I1, ListOfVarDeclarations ListOfVarDeclarations, MethDeclList MethDeclList) {
        this.I1=I1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclNoExtMeth(\n");
