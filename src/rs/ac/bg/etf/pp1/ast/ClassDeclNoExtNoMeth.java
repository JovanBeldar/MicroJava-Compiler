...
public class ClassDeclNoExtNoMeth extends ClassDecl {

    private String I1;
    private ListOfVarDeclarations ListOfVarDeclarations;

    public ClassDeclNoExtNoMeth (String I1, ListOfVarDeclarations ListOfVarDeclarations) {
        this.I1=I1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclNoExtNoMeth(\n");
